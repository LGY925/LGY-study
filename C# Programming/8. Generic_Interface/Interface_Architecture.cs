...
{
    internal class Interface_Architecture
    {
        /****************************************************************\
         * 추상클래스와 인터페이스
         * 
         ...
         * 하지만, 추상클래스와 인터페이스를 통해 얻는 효과는 다르며 다른 역활을 수행함
         * 개발자는 인터페이스와 추상클래스 중 더욱 상황에 적합한 것으로 구연해야 함
        \****************************************************************/
        ...
        // 추상클래스 (A is B 관계)
        // 상속 관계인 경우, 자식클래스가 부모 클래스의 하위 분류인 경우
